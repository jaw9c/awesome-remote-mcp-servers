...
| [Decision Anchor](https://mcp.decision-anchor.com/mcp) | Accountability Anchoring | `https://mcp.decision-anchor.com/mcp` | API Key | [Decision Anchor](https://github.com/zse4321/decision-anchor-sdk/blob/main/AGENTS.md) |
