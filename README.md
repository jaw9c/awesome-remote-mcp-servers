...
| Last Minute Deals HQ | Travel & Activities | `https://api.lastminutedealshq.com/mcp` | API Key | [Last Minute Deals HQ](https://github.com/johnanleitner1-Coder/lastminutedeals-api) |
